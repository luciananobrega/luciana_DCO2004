...
%      singleton*.
%
%      H = D01_GUI returns the handle to a new D01_GUI or the handle to
%      the existing singleton*.
%
%      D01_GUI('Property','Value',...) creates a new D01_GUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to D01_GUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      D01_GUI('CALLBACK') and D01_GUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in D01_GUI.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 15-Aug-2017 17:18:43
